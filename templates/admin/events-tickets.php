...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
    ...
    <button class="button fbm-button--glass"><?php esc_html_e( 'Issue', 'foodbank-manager' ); ?></button></p>
</form>
...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="display:inline">
    ...
    <button class="button fbm-button--glass"><?php esc_html_e( 'Send', 'foodbank-manager' ); ?></button>
</form>
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="display:inline">
    <input type="hidden" name="action" value="fbm_tickets_regen" />
    <input type="hidden" name="id" value="<?php echo esc_attr( (string) $t['id'] ); ?>" />
    <?php wp_nonce_field( 'fbm_tickets_regen' ); ?>
    <button class="button fbm-button--glass"><?php esc_html_e( 'Regenerate', 'foodbank-manager' ); ?></button>
</form>
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="display:inline" onsubmit="return confirm('<?php echo esc_js( __( 'Are you sure?', 'foodbank-manager' ) ); ?>');">
    ...
    <button class="button-link-delete fbm-button--glass"><?php esc_html_e( 'Revoke', 'foodbank-manager' ); ?></button>
</form>
</td>
</tr>
<?php endforeach; ?>
