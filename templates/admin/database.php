...
<td>
  <a href="<?php echo esc_url(add_query_arg(['page'=>'fbm-database','view'=>$r['id']])); ?>"><?php esc_html_e('View','foodbank-manager'); ?></a>
...
<?php if (current_user_can('fb_export_entries')) : ?>
<p><a class="button" href="<?php echo esc_url(add_query_arg(['action'=>'fbm_export_entries','_wpnonce'=>wp_create_nonce('fbm_db_export')], $base_url)); ?>"><?php esc_html_e('Export CSV','foodbank-manager'); ?></a></p>
<?php endif; ?>
</div>
