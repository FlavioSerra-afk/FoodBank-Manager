...
?>
<div class="wrap">
<h1><?php esc_html_e( 'Entry', 'foodbank-manager' ); ?> #<?php echo esc_html( (string) $entry['id'] ); ?></h1>
<p><a href="<?php echo esc_url( admin_url( 'admin.php?page=fbm-database' ) ); ?>">&larr; <?php esc_html_e( 'Back to list', 'foodbank-manager' ); ?></a></p>
<table class="form-table">
<tr><th><?php esc_html_e( 'Created', 'foodbank-manager' ); ?></th><td><?php echo esc_html( get_date_from_gmt( (string) $entry['created_at'] ) ); ?></td></tr>
<tr><th><?php esc_html_e( 'Status', 'foodbank-manager' ); ?></th><td><?php echo esc_html( (string) $entry['status'] ); ?></td></tr>
<tr><th><?php esc_html_e( 'Consent time', 'foodbank-manager' ); ?></th><td><?php echo esc_html( (string) $entry['consent_timestamp'] ); ?></td></tr>
</table>
<h2><?php esc_html_e( 'Fields', 'foodbank-manager' ); ?></h2>
<table class="widefat fixed">
<?php foreach ( $data as $k => $v ) : ?>
<tr><th><?php echo esc_html( $k ); ?></th><td><?php echo esc_html( is_array( $v ) ? wp_json_encode( $v ) : (string) $v ); ?></td></tr>
<?php endforeach; ?>
</table>
...
<?php endif; ?>
<p>
<a class="button" href="<?php echo esc_url( admin_url( 'admin.php?page=fbm-database' ) ); ?>"><?php esc_html_e( 'Back', 'foodbank-manager' ); ?></a>
...
<form method="post" style="display:inline" onsubmit="return confirm('<?php echo esc_js( __( 'Are you sure?', 'foodbank-manager' ) ); ?>');">
	...
	<input type="hidden" name="id" value="<?php echo esc_attr( (string) $entry['id'] ); ?>" />
	<?php wp_nonce_field( 'fbm_db_delete_' . $entry['id'] ); ?>
