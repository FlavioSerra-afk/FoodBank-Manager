...
$error        = isset( $token_probe['error'] ) ? (string) $token_probe['error'] : null;
?>
...
<section class="fbm-token-failures" aria-labelledby="fbm-token-failures-heading">
        ...
        <?php else : ?>
                <ul class="fbm-token-failures__list" role="list">
                        <?php foreach ( $token_failures as $failure ) :
                                ...
                                $attempts    = isset( $failure['attempts'] ) ? (int) $failure['attempts'] : 0;
                                ?>
