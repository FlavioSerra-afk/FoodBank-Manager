        ...
        <div id="forms" class="tab-section" style="display:none;">
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td><?php wp_dropdown_pages( array( 'name' => 'fbm_settings[forms][success_redirect_page_id]', 'selected' => $settings['forms']['success_redirect_page_id'], 'show_option_none' => __( '— Select —', 'foodbank-manager' ) ) ); ?></td>
                </tr>
            </table>
        </div>
