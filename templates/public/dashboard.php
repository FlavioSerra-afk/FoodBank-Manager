...
<div class="fbm-results-count" aria-live="polite"><?php printf( esc_html__( '%s results', 'foodbank-manager' ), esc_html( number_format_i18n( $present ) ) ); ?></div>
...
<?php $d = $deltas_attr['delivery'] ?? null; $cls = is_int( $d ) ? ( $d > 0 ? ' fbm-up' : ( $d < 0 ? ' fbm-down' : '' ) ) : ''; ?>
<?php if ( $tot > 0 ) : ?>
<div class="fbm-card">
