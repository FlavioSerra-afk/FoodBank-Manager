...
final class ThemePageTest extends \BaseTestCase {
    ...
    public function test_render_admin_tab_no_script(): void {
        ...
        $this->assertStringContainsString('fbm_theme[admin][style]', $out);
    ...
    public function test_render_front_tab_has_match_toggle(): void {
        ...
        ThemePage::route();
        $out = ob_get_clean();
        $this->assertStringContainsString('fbm_theme[front][enabled]', $out);
        $this->assertStringContainsString('fbm_theme[match_front_to_admin]', $out);
    }
}
