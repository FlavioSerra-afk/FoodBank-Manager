...
namespace {
    ...
    final class DiagnosticsPageTest extends TestCase {
        ...
        protected function setUp(): void {
            ...
            $GLOBALS['fbm_wp_mail_result'] = true;
            $GLOBALS['fbm_cron_next'] = array();
            $GLOBALS['fbm_cron_schedule'] = array();
            $GLOBALS['fbm_cron_schedules'] = array( 'daily' => array( 'interval' => DAY_IN_SECONDS ) );
        ...
        public function testSendTestEmailFailure(): void {
            ...
            $_SERVER['REQUEST_METHOD'] = 'POST';
            $_POST['fbm_action']       = 'mail_test';
            $GLOBALS['fbm_wp_mail_result'] = false;
            $_REQUEST                  = $_POST;
            try {
                DiagnosticsPage::route();
            } catch ( \RuntimeException $e ) {
