...
class Form {
    public static function render( array $atts = array() ): string {
        ...
        // Success screen
        $ref = isset( $_GET['fbm_ref'], $_GET['fbm_success'] ) ? Helpers::sanitize_text( wp_unslash( (string) $_GET['fbm_ref'] ) ) : '';
        if ( $ref !== '' ) {
        ...
        $errors = array();
        if ( isset( $_GET['fbm_err'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
            $raw    = explode( ',', (string) wp_unslash( $_GET['fbm_err'] ) );
        ...
        if ( isset( $_GET['fbm_error'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
            $has_error = true;
        }
