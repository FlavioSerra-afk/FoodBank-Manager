...
final class FormSubmitController {
    ...
    public static function handle(): void {
                ...
                try {
                        ...
                        $sanitized = self::validate_against_schema( $schema, $_POST );
	 ...
	 */
        ...
        private static function process_uploads( array $schema ): array {
                ...
                foreach ( $schema['fields'] as $field ) {
                        ...
                        $id        = (string) $field['id'];
                        $file_ids[] = $id;
                        $file      = $_FILES[ $id ] ?? null; // phpcs:ignore WordPress.Security.NonceVerification.Missing
        ...
        private static function hash_ip(): string {
                ...
                $hash = substr( hash( 'sha256', $ip ), 0, 32 );
                return pack( 'H*', $hash );
        }
}
