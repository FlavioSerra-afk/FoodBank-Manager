    ...
    public static function route(): void {
        ...
        if ('POST' === $method) {
            ...
            if (isset($_POST['delete_form'])) {
                ...
                wp_safe_redirect(add_query_arg(['page' => 'fbm_form_builder', 'notice' => 'form_deleted'], admin_url('admin.php')));
                return;
            }
            ...
            wp_safe_redirect(add_query_arg(['page' => 'fbm_form_builder', 'form_id' => $form_id, 'notice' => 'form_saved'], admin_url('admin.php')));
            return;
        }
        $forms = FormRepo::list();
        $current = null;
        ...
        if ($id) {
            ...
            $current = ['id' => 0, 'title' => '', 'schema' => ['fields' => []], 'mask_sensitive' => true, 'version' => 1];
        }
