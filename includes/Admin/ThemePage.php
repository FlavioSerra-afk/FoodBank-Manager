	...
	private static function handle_post(): void {
		...
		if ( isset( $_POST['fbm_theme_import'] ) ) {
			...
			exit;
				...
				$data      = isset( $_POST['fbm_theme'] ) && is_array( $_POST['fbm_theme'] ) ? (array) wp_unslash( $_POST['fbm_theme'] ) : array(); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Sanitized in Options::saveAll.
		$settings          = Options::all();
		$settings['theme'] = $data;
		Options::saveAll( $settings );
