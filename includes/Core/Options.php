...
class Options {
    ...
    private static function defaults(): array {
        return [
            ...
            'attendance' => [
                'policy_days' => 7,
                'types' => ['in_person','delivery','other'],
            ],
            'privacy' => [
                'retention_months' => 24,
    ...
    public static function saveAll(array $new): bool {
        ...
        $merged['forms']['captcha_provider'] = in_array($merged['forms']['captcha_provider'], ['off','recaptcha','turnstile'], true) ? $merged['forms']['captcha_provider'] : 'off';
        ...
        $merged['attendance']['types'] = $types ?: ['in_person'];

        $merged['privacy']['retention_months'] = max(0, (int) ($merged['privacy']['retention_months'] ?? 24));
        $merged['privacy']['anonymise_files'] = in_array($merged['privacy']['anonymise_files'], ['delete','keep','move'], true) ? $merged['privacy']['anonymise_files'] : 'delete';
