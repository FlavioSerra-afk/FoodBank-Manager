	...
	public static function maybe_enqueue_staff_dashboard(): void {
		...
		$data = array(
			...
			'strings'  => array(
				...
				'already'                  => esc_html__( 'Member already collected today.', 'foodbank-manager' ),
				...
				'revoked'                  => esc_html__( 'This code has been revoked.', 'foodbank-manager' ),
				'throttled'                => esc_html__( 'Please wait a moment before trying again.', 'foodbank-manager' ),
